...
<input type="hidden"   value="login"  name="tecnico"> <!--  llave para el controlador -->
...
<div class="container">
<form  class="row g-1 needs-validation was-validated" action="../Controllers/SoporteControllers.php" method="POST">
<input type="hidden"   value="register"  name="tecnico"> <!--  llave para el controlador -->
